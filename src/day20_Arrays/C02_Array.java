...
public class C02_Array {
    public static void main(String[] args) {
        ...
        her zaman direkt yazdıramayabiliriz
        array'i yazdırmak istersek javadaki arrays clasından
        yardım isteriz
         */
        ...
        sayilar[0]=5;
        sayilar[1]=3;
        System.out.println(sayilar);//[I@19dfb72a  değer atasan bile böyle çağırılmıyor
        ...
        System.out.println(sinifList[1]);//sadece hasan yazdıralım
