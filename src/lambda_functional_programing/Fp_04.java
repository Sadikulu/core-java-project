...
public class Fp_04 {
    public static void main(String[] args) {
        ...
        System.out.println(ikiSayiArasindaCiflerinToplami(7,5));
        System.out.println(ikiSayiArasindakiTumSayilarinRakamlariTolami(23,32));
    ...
    public static int factoriyel(int x){
        if (x > 0) {
            ...
            System.out.println("Sıfırdan büyük değer gir");
       return 0;
    }

    //4) Verilen iki sayı arasındaki çift sayıların
    // toplamını bulan bir method oluşturun.
    public static int ikiSayiArasindaCiflerinToplami(int x,int y){
        int z=0;
        if (x>y){
           z=x;
           x=y;
    ...
    public static int ikiSayiArasindakiTumSayilarinRakamlariTolami(int x,int y){
        int z=0;
        if (x>y){
            z=x;
            x=y;
